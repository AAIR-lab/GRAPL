...
class AbstractTD:
    ...
    def _get_value(self, config_dict, key):
        ...
        try:
            ...
            return AbstractTD.DEFAULTS[key]
...
#             target = reward + self._gamma * q_values[i] * (1 - done)
    ...
    def evaluate_qlearn(self, problem, old_ran, num_episodes=10,
                        epsilon=0.0):
    ...
    def qlearn_with_episode_limit(self, domain_filepath,
                                  problem_filepath, old_ran, new_ran, evaluator,
                                  cost_results, episode_results):
...
#                     done = True
    ...
    def run(self, input_dir, cost_results, episode_results):
        ...
        for problem_filepath in problem_list:
            ...
            self.qlearn_with_episode_limit(domain_filepath, problem_filepath,
                                           old_ran, new_ran, evaluator,
                                           cost_results, episode_results)

...
class ChildsnackNN:
    ...
    def get_2p_7h(abstract_domain):
        ...
        concatenated = []
        concatenated.append(input_1)
        concatenated.append(input_2)
        for binary_predicate in abstract_domain.get_binary_predicates():
            ...
            concatenated.append(keras.layers.Reshape(
                (1, np.prod(output_shape)))(binary_pred))
            concatenated.append(keras.layers.Reshape(
                (1, np.prod(output_shape)))(role_count_binary_pred))

        concatenated_input = keras.layers.concatenate(concatenated)

        h_0 = keras.layers.Dense(64, activation="relu")(concatenated_input)
        h_1 = keras.layers.Dense(64, activation="relu")(h_0)

        h_2 = keras.layers.Dense(64, activation="sigmoid")(concatenated_input)
        h_3 = keras.layers.Dense(64, activation="sigmoid")(h_2)

        h_4 = keras.layers.Dense(64, activation="sigmoid")(concatenated_input)
        h_5 = keras.layers.Dense(64, activation="sigmoid")(h_4)

        h_6 = keras.layers.Dense(64, activation="sigmoid")(concatenated_input)
        h_7 = keras.layers.Dense(64, activation="sigmoid")(h_6)

        h_8 = keras.layers.Dense(64, activation="sigmoid")(concatenated_input)
        h_9 = keras.layers.Dense(64, activation="sigmoid")(h_8)

        h_10 = keras.layers.Dense(64, activation="relu")(concatenated_input)
        h_11 = keras.layers.Dense(64, activation="relu")(h_10)
    ...
    def get_nn(abstract_domain, nn_name):
        ...
        if "2p_7h" == nn_name:
            ...
            model, output_index_dict, arch = ChildsnackNN.get_2p_7h(
                abstract_domain)
        else:

...
class HanoiNN:
    ...
    def get_2p_7h(abstract_domain):
        ...
        h_0 = keras.layers.Dense(128)(binned_input)
        h_00 = keras.layers.Dense(64, activation="relu")(h_0)
        h_000 = keras.layers.Dense(32, activation="relu")(h_00)
        h_1 = keras.layers.Dense(16, activation="relu")(h_000)

        h_2 = keras.layers.Dense(128, activation="sigmoid")(binned_input)
        h_22 = keras.layers.Dense(64, activation="sigmoid")(h_2)
        h_222 = keras.layers.Dense(32, activation="sigmoid")(h_22)
        h_3 = keras.layers.Dense(16, activation="sigmoid")(h_222)

        h_4 = keras.layers.Dense(128, activation="sigmoid")(binned_input)
        h_44 = keras.layers.Dense(64, activation="sigmoid")(h_4)
        h_444 = keras.layers.Dense(32, activation="sigmoid")(h_44)
        h_5 = keras.layers.Dense(16, activation="sigmoid")(h_444)

        h_6 = keras.layers.Dense(128, activation="sigmoid")(binned_input)
        h_66 = keras.layers.Dense(64, activation="sigmoid")(h_6)
        h_666 = keras.layers.Dense(32, activation="sigmoid")(h_66)
        h_7 = keras.layers.Dense(16, activation="sigmoid")(h_666)

        h_8 = keras.layers.Dense(128, activation="relu")(raw_input)
        h_88 = keras.layers.Dense(64, activation="relu")(h_8)
        h_888 = keras.layers.Dense(32, activation="relu")(h_88)
        h_9 = keras.layers.Dense(16, activation="relu")(h_888)
    ...
    def get_nn(abstract_domain, nn_name):
        ...
        if "2p_7h" == nn_name:
            ...
            model, output_index_dict, arch = HanoiNN.get_2p_7h(
                abstract_domain)
        else:

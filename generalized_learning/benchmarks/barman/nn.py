...
class BarmanNN:
    ...
    def get_2p_7h(abstract_domain):
        ...
        h_6 = keras.layers.Dense(64, activation="sigmoid")(binned_input)
        h_7 = keras.layers.Dense(64, activation="sigmoid")(h_6)

        h_8 = keras.layers.Dense(64, activation="sigmoid")(binned_input)
        h_9 = keras.layers.Dense(64, activation="sigmoid")(h_8)

        h_10 = keras.layers.Dense(64, activation="sigmoid")(binned_input)
        h_11 = keras.layers.Dense(64, activation="sigmoid")(h_10)

        h_12 = keras.layers.Dense(64, activation="sigmoid")(binned_input)
        h_13 = keras.layers.Dense(64, activation="sigmoid")(h_12)

        h_14 = keras.layers.Dense(64, activation="relu")(raw_input)
        h_15 = keras.layers.Dense(64, activation="relu")(h_14)
        ...
        output_4 = keras.layers.Dense(
            action_param_preds_shape,
            activation="sigmoid",
            name="action_param_2_preds")(h_7)

        output_5 = keras.layers.Dense(
            action_param_preds_shape,
            activation="sigmoid",
            name="action_param_3_preds")(h_9)

        output_6 = keras.layers.Dense(
            action_param_preds_shape,
            activation="sigmoid",
            name="action_param_4_preds")(h_11)

        output_7 = keras.layers.Dense(
            action_param_preds_shape,
            activation="sigmoid",
            name="action_param_5_preds")(h_13)

        output_8 = keras.layers.Dense(
            abstract_domain.get_nn_output_shape("plan_length"),
            activation="relu",
            name="plan_length")(h_15)
        ...
        loss_func_dict = {
            ...
            "action_param_2_preds": "binary_crossentropy",
            "action_param_3_preds": "binary_crossentropy",
            "action_param_4_preds": "binary_crossentropy",
            "action_param_5_preds": "binary_crossentropy",
            "plan_length": "mae",
        }
        ...
        loss_weights_dict = {
            ...
            "action_param_2_preds": 1.0,
            "action_param_3_preds": 1.0,
            "action_param_4_preds": 1.0,
            "action_param_5_preds": 1.0,
            "plan_length": 1.0,
        }
        ...
        metrics_dict = {
            ...
            "action_param_2_preds": "binary_accuracy",
            "action_param_3_preds": "binary_accuracy",
            "action_param_4_preds": "binary_accuracy",
            "action_param_5_preds": "binary_accuracy",
            "plan_length": "mae",
        }
    ...
    def get_nn(abstract_domain, nn_name):
        ...
        if "2p_7h" == nn_name:
            ...
            model, output_index_dict, arch = BarmanNN.get_2p_7h(
                abstract_domain)
        else:

...
class FerryNN:
    ...
    def get_2p_7h(abstract_domain):
        ...
        h_0 = keras.layers.Dense(32, activation="sigmoid")(concatenated_input)
        h_1 = keras.layers.Dense(32, activation="sigmoid")(h_0)

        h_2 = keras.layers.Dense(32, activation="sigmoid")(concatenated_input)
        h_3 = keras.layers.Dense(32, activation="sigmoid")(h_2)

        h_4 = keras.layers.Dense(32, activation="sigmoid")(concatenated_input)
        h_5 = keras.layers.Dense(32, activation="sigmoid")(h_4)

        h_6 = keras.layers.Dense(32, activation="relu")(concatenated_input)
    ...
    def get_nn(abstract_domain, nn_name):
        ...
        if "2p_7h" == nn_name:
            ...
            model, output_index_dict, arch = FerryNN.get_2p_7h(
                abstract_domain)
        else:

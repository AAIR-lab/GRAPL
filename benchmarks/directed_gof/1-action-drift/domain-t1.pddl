...
(:predicates (achieved ?g - object) (executed-action))
	...
	(:action achieve-goal-v1-a
		...
		:precondition 
			(and (not (achieved ?g)))
		:effect (and (probabilistic 0.1 (and (achieved ?g) (not (executed-action)))
					    0.9 (and (executed-action))
			))
	)
	...
	(:action achieve-goal-v2-a
		...
		:precondition 
			(and (not (achieved ?g)))
		:effect (and (probabilistic 0.9 (and (achieved ?g) (not (executed-action)))
					    0.1 (and (executed-action)))
			))
	)

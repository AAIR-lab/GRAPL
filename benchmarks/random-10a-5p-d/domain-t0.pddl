...
(:predicates (pred0-p ?v0 - type0-t ?v1 - type0-t) (pred1-p ?v0 - type0-t ?v1 - type0-t) (pred2-p ?v0 - type0-t ?v1 - type0-t) (pred3-p ?v0 - type0-t ?v1 - type0-t) (pred4-p ?v0 - type0-t ?v1 - type0-t))
	...
	(:action action6-a
		...
		:precondition 
			(and (pred3-p ?x1 ?x0)
			(pred4-p ?x0 ?x1))
		:effect (and  (not (pred3-p ?x1 ?x0)) (pred1-p ?x0 ?x1) (pred1-p ?x1 ?x0) (probabilistic 1.000000 (and
			)))
	)
	...
	(:action action8-a
		...
		:precondition 
			(and (pred0-p ?x1 ?x0)
			(not (pred2-p ?x0 ?x1)))
		:effect (and  (not (pred3-p ?x0 ?x1)) (pred2-p ?x0 ?x1) (pred2-p ?x1 ?x0) (pred4-p ?x1 ?x0) (probabilistic 1.000000 (and
			)))
	)

...
(:predicates (dec_f ?v0 - floor ?v1 - floor) (dec_p ?v0 - pos ?v1 - pos) (in ?v0 - elevator ?v1 - floor) (at ?v0 - floor ?v1 - pos) (shaft ?v0 - elevator ?v1 - pos) (inside ?v0 - elevator) (gate ?v0 - floor ?v1 - pos) (coin-at ?v0 - coin ?v1 - floor ?v2 - pos) (have ?v0 - coin) (underground) (is-first-floor ?v0 - floor) (is-first-position ?v0 - pos))
	...
	(:action go-down
		...
		:precondition 
			(and (not (underground))
			(dec_f ?f ?nf))
		:effect (and  (not (in ?e ?f)) (underground) (probabilistic 1.000000 (and
			)))
	)
	...
	(:action move-left-nogate
		...
		:precondition 
			...
			(dec_p ?p ?np)
			(not (gate ?f ?p)))
		:effect (and  (not (at ?f ?p)) (at ?f ?np) (is-first-position ?np) (probabilistic 1.000000 (and
			)))
	)
	...
	(:action move-right-gate
		...
		:effect (and  (probabilistic 0.800000 (and
			(at ?f ?np)
			(is-first-position ?np)) 0.200000 (and
			(not (at ?f ?p)))))
	)
	...
	(:action move-right-nogate
		...
		:precondition 
			...
			(gate ?f ?p)
			(not (dec_p ?np ?p)))
		:effect (and  (is-first-position ?np) (underground) (probabilistic 1.000000 (and
			)))
	)

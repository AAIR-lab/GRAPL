...
/* number of states that got expanded.
*/
...

{
  ...
  printf( "\n            %7.2f seconds building connectivity graph",
	  gconn_time );
  printf( "\n            %7.2f seconds searching, expanding %d states, evaluating %d states, to a max depth of %d", 
	  gsearch_time, gexpanded_states, gevaluated_states, gmax_search_depth );
